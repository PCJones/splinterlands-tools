...
namespace Asset_Transfer_Bot_by_PC_Jones.Classes
{
    class HttpWebRequest
    {
        ...
        public string WebRequestPost(System.Net.CookieContainer CookieContainer, string PostData, string Url, string UserAgent, string Referer, Encoding responseEncoding, string proxy = "")
        {
        ...
        /// <param name="Referer">Referer to be used</param>
        /// <returns>Returns the website sourcecode</returns>
        public string WebRequestGet(System.Net.CookieContainer CookieContainer, string Url, string UserAgent, string Referer, string proxy = "")
        {
            string websiteResponse = "";
